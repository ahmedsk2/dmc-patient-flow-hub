...
| P19 | Destruction / secure disposal | | Soft deletes + admin hard delete with step-up and audit row; `DATA-RETENTION.md` §5; bucket lifecycle rules; legacy dump shredding (`BACKUP-AND-RESTORE.md` §2.7); workstation clean-up inventory, 38 files hashed then recycled 2026-09-24 ([`evidence/workstation-phi-cleanup-2026-09-24.md`](evidence/workstation-phi-cleanup-2026-09-24.md)) | Owner empties the Recycle Bin and drops the laptop's real-data WAMP databases; retention decision for Coolify's unencrypted dumps and the 2026-07-19 boot-volume backup | PARTIAL |
