...
| C9 | Whole-disk boot-volume backups of the host (every app's data) | OCI `me-riyadh-1` | Operator company; Oracle | OCI backup policy `weekly-4` expires them after four weeks; the one manual full backup without expiry (2026-07-19) was deleted by the owner 2026-09-24 (§2.3) |
...
| Boot-volume backups of the host | **Laravel (C9)** — OCI `me-riyadh-1` | OCI volume backup policy `weekly-4`, weekly | Four weeks (policy) | Four scheduled (verified 2026-09-24); the manual full backup of 2026-07-19, which had no expiry, deleted by the owner 2026-09-24 | OCI backup policy | Scheduled expiry |
