...
| C6 | Migration dumps and exports | Operator workstations, the OCI host under `/home/ubuntu/migrate/dmc/` (CONFIRMED-FACTS D1) | Operator company | Manual. Host copies shredded 2026-09-03; the workstation's DMC files inventoried and destroyed 2026-09-24 (hashed, recycled, bin emptied by the owner — [`evidence/workstation-phi-cleanup-2026-09-24.md`](evidence/workstation-phi-cleanup-2026-09-24.md)) — **GAP** until the owner drops the laptop's real-data databases (§2.3) |
