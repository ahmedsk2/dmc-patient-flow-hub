...
| D7 | Backup geography (owner, 2026-09-24) | **Riyadh only — no second cloud region.** The owner keeps an additional local copy of the encrypted backup objects. The empty Jeddah test bucket was deleted the same day. | CONFIRMED |
