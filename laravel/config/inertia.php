    ...
    */
    ...
    'pages' => [
        ...
        'paths' => [
            ...
            // Published from the vendor default SPECIFICALLY to fix this line's casing: the
            // package ships lowercase js/pages, which Windows resolves to our js/Pages but a
            // case-sensitive CI runner does not — every assertInertia()->component() then fails
            // with "component file does not exist" on Linux only.
