...
class HandoverSignature extends Model
{
    ...
    public function fromConsultant(): BelongsTo
    {
        return $this->belongsTo(User::class, 'from_consultant_id');
    }

    public function toConsultant(): BelongsTo
    {
        return $this->belongsTo(User::class, 'to_consultant_id');
    }
    ...
    {
        return $this->belongsTo(HandoverRevision::class, 'revision_id');
    }

    /** Unsigned and not voided — awaiting a signature. */
    public function scopePending(Builder $q): Builder
    {
        return $q->whereNull('signed_at')->whereNull('voided_at');
    }
