...
<template>
    <AppLayout title="Audit Log" :breadcrumbs="[
        ...
        <div class="mb-4 flex items-center gap-2 text-sm">
            ...
            <span v-if="integrityThrough" class="inline-flex items-center gap-1 font-semibold text-brand-700">Hash chain intact through {{ integrityDate }}<InfoTip label="Hash chain intact" text="Each row is cryptographically linked to the one before it. This date is the newest row with a hash recorded — the full chain is re-verified nightly." /></span>
